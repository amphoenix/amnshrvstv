...
const SocialLink = ({ href, icon: Icon }) => (
    ...
    >
        <a href={href} target="_blank" rel="noreferrer" className="text-white hover:text-gray-300">
            <Icon />
        </a>
    </motion.li>
);
                ...
                <div className="flex justify-center">
                    <div className="md:w-1/2">
                        <div className="text-center mb-4">
                            <a href="#" className="text-2xl font-bold text-white hover:text-gray-300">K.A<span className="text-red-500">.</span></a>
                        </div>
