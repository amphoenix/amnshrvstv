  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className='bg-tertiary border border-black-200 p-5 rounded-2xl sm:w-[360px] w-full h-[430px] flex flex-col shadow-card'
      >
        ...
        <div className='mt-5 flex-1 flex flex-col justify-between'>
          <div>
            ...
            <p className='project-desc-clamp mt-2 text-secondary text-[14px]'>
              {description}
            </p>
          </div>
