    ...
    <a href={url} target='_blank' rel='noopener noreferrer'>
      ...
      >
        <div
          ...
          className='bg-tertiary border border-black-200 shadow-card rounded-[25px] py-6 px-10 min-h-[300px] flex justify-evenly items-center flex-col'
        >
          <img
            src={icon}
            alt={title}
...
const About = () => {
  ...
  return (
    <>
      ...
      >
        AI Systems Engineer with{' '}
        <span style={{ fontSize: '20px', fontWeight: 'bold' }}>
          {experience} years
        </span>{' '}
        of experience designing production AI applications using LLMs,
        multi-agent systems, RAG, semantic memory, and Go. Experienced in
        building AI developer platforms, orchestration frameworks, and
        scalable frontend &amp; backend services for enterprise workflows.
      </motion.p>
